...
export function AddressCardItem({ address, country, city }: IAddressCardItemProps) {
  return (
    <Card>
      <CardContent className="grid grid-cols-8">
        <div className="flex items-center gap-x-3 col-span-7">
          ...
          <div className="flex flex-col">
            ...
            <Typography variant="small-2" color="text-neutral-gray" className="inline-block mt-1">
              {country}
            </Typography>
            <Typography
              variant="body-2"
