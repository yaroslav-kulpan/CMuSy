...
export const IconWeatherThermometer: React.FunctionComponent<IconProps> = ({
  color = "currentColor",
  size = 24,
  ...other
}) => {
...
IconWeatherThermometer.propTypes = {
